...
#define FLAG_DID_COPYCAT_TRADE                           0x277
...
#define FLAG_PLAYER_ADVENTURE_STARTED                               (SYS_FLAGS + 0x2A)
#define FLAG_PLAYER_5A0_SEED                                        (SYS_FLAGS + 0x2B)
