...
const u8 gTypeEffectiveness[351] =
{
    ...
    //Inspired by
    // https://github.com/resetes12/pokeemerald/commit/e8d7c200fe7a862330aea0fceeb819979ab4acb4
    //This is just a workaround in case I forget anything
    // Most pokemon pre fairy are mono, so this would only change new introduced pokemon 
    // by other romhacks
    TYPE_FAIRY, TYPE_ROCK, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_FAIRY, TYPE_STEEL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_FIGHTING, TYPE_FAIRY, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GHOST, TYPE_FAIRY, TYPE_MUL_NO_EFFECT,
    TYPE_FAIRY, TYPE_GHOST, TYPE_MUL_NO_EFFECT,
...
const u8 gTypeEffectiveness_Modern[369] =
{
    TYPE_NORMAL, TYPE_ROCK, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_NORMAL, TYPE_STEEL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_FIRE, TYPE_FIRE, TYPE_MUL_NOT_EFFECTIVE,
