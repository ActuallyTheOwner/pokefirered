...
static const struct SpritePalette sObjectEventSpritePalettes[] = {
    {gObjectEventPal_NpcBlue,                  OBJ_EVENT_PAL_TAG_NPC_1},
    {gObjectEventPal_NpcPink,                  OBJ_EVENT_PAL_TAG_NPC_2},
    {gObjectEventPal_NpcGreen,                 OBJ_EVENT_PAL_TAG_NPC_3},
    {gObjectEventPal_NpcWhite,                 OBJ_EVENT_PAL_TAG_NPC_4},
    {gObjectEventPal_NpcBlueReflection,        OBJ_EVENT_PAL_TAG_NPC_1_REFLECTION},
...
static const u16 sObjectPaletteTags0[] = {
    [PALSLOT_PLAYER]            = OBJ_EVENT_PAL_TAG_BRENDAN_MAY,
    [PALSLOT_PLAYER_REFLECTION] = OBJ_EVENT_PAL_TAG_BRENDAN_MAY_REFLECTION,
...
u8 CreateFameCheckerObject(u8 graphicsId, u8 localId, s16 x, s16 y)
{
    ...
    if (spriteId != MAX_SPRITES)
    {
        ...
        if (spriteTemplate.paletteTag != 0xFFFF)// bugged
            LoadObjectEventPalette(spriteTemplate.paletteTag);// bugged
            UpdatePaletteGammaType(IndexOfSpritePaletteTag(spriteTemplate.paletteTag), GAMMA_ALT);//
...
void LoadObjectEventPalette(u16 paletteTag) //Not static in https://github.com/pret/pokeemerald/compare/master...ExpoSeed:pokeemerald:dynamic-ow-pals#diff-6f5d72580cae5e5e12d7adff8df13b7eec1245b32ffe34aacb5e92c4f6555c0fL30
{
...
static bool8 IsElevationMismatchAt(u8 elevation, s16 x, s16 y)
{
    ...
    if (mapElevation == 0 || mapElevation == ELEVATION_MULTI_LEVEL)
        return FALSE;
