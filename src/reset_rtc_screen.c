...
static void PrintTime(u8 windowId, u8 x, u8 y, u16 days, u8 hours, u8 minutes, u8 seconds)
{
    ...
    AddTextPrinterParameterized(windowId, 1, gStringVar4, x, y, TEXT_SKIP_DRAW, NULL);
}
...
static void ShowChooseTimeWindow(u8 windowId, u16 days, u8 hours, u8 minutes, u8 seconds)
{
    ...
    AddTextPrinterParameterized(windowId, 1, gText_Confirm, 126, 1, 0, NULL);
    ScheduleBgCopyTilemapToVram(0);
}
...
static void Task_ShowResetRtcPrompt(u8 taskId)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterized(0, 1, gText_PresentTime, 0, 1, TEXT_SKIP_DRAW, 0);
        PrintTime(
            0,
            0,
            17,
            ...
            gLocalTime.minutes,
            gLocalTime.seconds);
        AddTextPrinterParameterized(0, 1, gText_PreviousTime, 0, 33, TEXT_SKIP_DRAW, 0);
        PrintTime(
            0,
            0,
            49,
