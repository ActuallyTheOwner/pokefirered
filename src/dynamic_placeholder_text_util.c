...
static const u8 sTextColorTable[] =
{
 // [LOW_NYBBLE / 2]                            = 0xXY, // HIGH_NYBBLE
    ...
    //Some cool new stuff
    [OBJ_EVENT_GFX_RIVAL_BOY / 2]               = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_DEOXYS_A
    [OBJ_EVENT_GFX_RIVAL_GIRL / 2]              = COLORS(NPC_TEXT_COLOR_FEMALE, NPC_TEXT_COLOR_FEMALE), // OBJ_EVENT_GFX_DEOXYS_A

    [OBJ_EVENT_GFX_BRENDAN_NORMAL / 2]          = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_BRENDAN_BIKE
    [OBJ_EVENT_GFX_BRENDAN_SURF / 2]            = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_BRENDAN_FIELD_MOVE
    [OBJ_EVENT_GFX_BRENDAN_FISH / 2]            = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_BRENDAN_VS_SEEKER
    [OBJ_EVENT_GFX_BRENDAN_VS_SEEKER_BIKE / 2]  = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_GREEN_NORMAL

    [OBJ_EVENT_GFX_MAY_NORMAL / 2]              = COLORS(NPC_TEXT_COLOR_FEMALE, NPC_TEXT_COLOR_FEMALE), // OBJ_EVENT_GFX_MAY_BIKE
    [OBJ_EVENT_GFX_MAY_SURF / 2]                = COLORS(NPC_TEXT_COLOR_FEMALE, NPC_TEXT_COLOR_FEMALE), // OBJ_EVENT_GFX_MAY_FIELD_MOVE
    [OBJ_EVENT_GFX_MAY_FISH / 2]                = COLORS(NPC_TEXT_COLOR_FEMALE, NPC_TEXT_COLOR_FEMALE), // OBJ_EVENT_GFX_MAY_VS_SEEKER
    [OBJ_EVENT_GFX_MAY_VS_SEEKER_BIKE / 2]      = COLORS(NPC_TEXT_COLOR_FEMALE, NPC_TEXT_COLOR_FEMALE), // OBJ_EVENT_GFX_GREEN_NORMAL
};
