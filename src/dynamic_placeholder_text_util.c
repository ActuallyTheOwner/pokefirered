...
static const u8 sTextColorTable[] =
{
 // [LOW_NYBBLE / 2]                            = 0xXY, // HIGH_NYBBLE
    ...
    [OBJ_EVENT_GFX_BRENDAN_VS_SEEKER_BIKE / 2]  = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_FEMALE), // OBJ_EVENT_GFX_MAY_NORMAL
    [OBJ_EVENT_GFX_MAY_BIKE / 2]                = COLORS(NPC_TEXT_COLOR_FEMALE, NPC_TEXT_COLOR_FEMALE), // OBJ_EVENT_GFX_MAY_SURF
    [OBJ_EVENT_GFX_MAY_FIELD_MOVE / 2]          = COLORS(NPC_TEXT_COLOR_FEMALE, NPC_TEXT_COLOR_FEMALE), // OBJ_EVENT_GFX_MAY_FISH
    [OBJ_EVENT_GFX_MAY_VS_SEEKER / 2]           = COLORS(NPC_TEXT_COLOR_FEMALE, NPC_TEXT_COLOR_FEMALE), // OBJ_EVENT_GFX_MAY_VS_SEEKER_BIKE
