...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_BrendanFieldMove = {
    ...
    .subspriteTables = gObjectEventSpriteOamTables_16x32,
    .anims = sAnimTable_RedGreenFieldMove,
    .images = sPicTable_BrendanItem,
    .affineAnims = gDummySpriteAffineAnimTable,
};

const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_BrendanBikeAlt = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_BRENDAN_MAY,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_BRIDGE_REFLECTION,
    .size = 512,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_MayFieldMove = {
    ...
    .subspriteTables = gObjectEventSpriteOamTables_16x32,
    .anims = sAnimTable_RedGreenFieldMove,
    .images = sPicTable_MayItem,
    .affineAnims = gDummySpriteAffineAnimTable,
};

const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_MayBikeAlt = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_BRENDAN_MAY,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_BRIDGE_REFLECTION,
    .size = 512,
