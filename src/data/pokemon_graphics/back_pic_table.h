...
//See SpeciesHasGenderDifference
const struct CompressedSpriteSheet gFemaleMonBackPicTable[] =
{
    SPECIES_SPRITE(VENUSAUR, gFemaleMonBackPic_Venusaur),
    SPECIES_SPRITE(BUTTERFREE, gFemaleMonBackPic_Butterfree),
    SPECIES_SPRITE(RATTATA, gFemaleMonBackPic_Rattata),
    SPECIES_SPRITE(RATICATE, gFemaleMonBackPic_Raticate),
    SPECIES_SPRITE(PIKACHU, gFemaleMonBackPic_Pikachu),
    SPECIES_SPRITE(RAICHU, gMonBackPic_Raichu), // No difference from male
    SPECIES_SPRITE(ZUBAT, gFemaleMonBackPic_Zubat),
    SPECIES_SPRITE(GOLBAT, gFemaleMonBackPic_Golbat),
    SPECIES_SPRITE(GLOOM, gFemaleMonBackPic_Gloom),
    SPECIES_SPRITE(VILEPLUME, gFemaleMonBackPic_Vileplume),
    SPECIES_SPRITE(KADABRA, gMonBackPic_Kadabra),
    SPECIES_SPRITE(ALAKAZAM, gMonBackPic_Alakazam),
    SPECIES_SPRITE(DODUO, gMonBackPic_Doduo),
    SPECIES_SPRITE(DODRIO, gMonBackPic_Dodrio),
