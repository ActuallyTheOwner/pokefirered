...
static void (*const sLinkOpponentBufferCommands[CONTROLLER_CMDS_COUNT])(void) =
{
    ...
    [CONTROLLER_CLEARUNKVAR]              = LinkOpponentHandleCmd32, //Filler
    [CONTROLLER_SETUNKVAR]                = LinkOpponentHandleCmd32, //
    [CONTROLLER_CLEARUNKFLAG]             = LinkOpponentHandleCmd32, //
    [CONTROLLER_TOGGLEUNKFLAG]            = LinkOpponentHandleCmd32, //
